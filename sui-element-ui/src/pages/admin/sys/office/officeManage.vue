  ...
  <div class="body">
    <el-row class="div-shadow" style="border: solid 1px rgba(128,128,128,0.41);height:750px;border-radius: 10px">
      ...
      <el-col :span="20" style="border-left: solid 1px rgba(128,128,128,0.41);height:750px;padding: 20px">
        ...
        <el-table border row-key="id" ref="dataTreeList" height="600" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" :header-cell-style="{background:'#f4f4f5'}" :height="600" v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="操作" align="left" width="380">
            <template slot-scope="scope">
