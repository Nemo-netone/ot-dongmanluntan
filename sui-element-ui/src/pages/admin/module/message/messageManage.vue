...
<template>
  <div class="body">
    ...
    <!-- 表格区域 -->
    <el-table border row-key="id" :header-cell-style="{background:'#f4f4f5'}" :height="600" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
