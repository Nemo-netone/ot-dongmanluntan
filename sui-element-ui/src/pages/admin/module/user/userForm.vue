    ...
    <el-dialog width="600px" :title="dialog.title" :close-on-click-modal="false" :visible.sync="dialog.open">
      <el-form :model="sysUser" ref="sysUserForm" :rules="rules" label-width="100px">
        ...
        <el-form-item label="登录账号" prop="loginName">
          <el-input v-model="sysUser.loginName" placeholder="请输入登录账号" :disabled="dialog.disabled" class="sui-input"></el-input>
        </el-form-item>
        <el-form-item label="用户姓名" prop="userName">
          <el-input v-model="sysUser.userName" placeholder="请输入用户姓名" :disabled="dialog.disabled" class="sui-input"></el-input>
        </el-form-item>
        <el-form-item label="用户性别" prop="sex">
          <el-select v-model="sysUser.sex" placeholder="请选择用户性别" :disabled="dialog.disabled" class="sui-input">
        ...
        <el-form-item label="所属角色" v-if="!sysUser.id && allRole.length>0" prop="roleList" >
    ...
    data() {
      return {
        ...
        rules: {
          ...
          loginName: [{required: true, message: '请输入登录账号', trigger: 'blur'},{validator: this.$validator.unique, form: this, model: 'sysUser', tableName: 'sys_user', column: 'login_name', message: '登录账号已存在', trigger: 'blur'}],
