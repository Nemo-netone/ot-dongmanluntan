    ...
    <el-dialog width="600px" :title="dialog.title" :close-on-click-modal="false" :visible.sync="dialog.open">
      <el-form :model="user" ref="passwordForm" :rules="rules" label-width="100px">
        <el-form-item label="登录账号" prop="loginName">
          <el-input v-model="user.loginName" disabled placeholder="请输入登录账号" style="width: 217px"></el-input>
        </el-form-item>
        ...
        <el-form-item label="新的密码" prop="newPassword">
          <el-input v-model="user.newPassword" type="password" placeholder="请输入新的密码" :disabled="dialog.disabled" style="width: 217px"></el-input>
        </el-form-item>
