  ...
  <div class="front-body">
    <el-card class="front-card">
      <div class="message">
        ...
        <h1 class="font-shadow msg-title">社区交流</h1>
        ...
        <div v-if="dataList.length>0" class="comment-list">
          <div class="comment-info" v-for="item in dataList" :key="item.id">
            ...
            <div class="comment-right">
              ...
              <div class="comment-content-footer">
                <el-button style="margin-bottom: 2px" v-if="userInfo && (item.userId != userInfo.id)" @click="replyUser(item)" class="float-r" type="primary" plain size="mini" icon="el-icon-edit" circle title="回复"></el-button>
                <el-button style="margin-bottom: 2px" v-if="userInfo && (item.userId == userInfo.id)" @click="del(item.id)" class="float-r" type="warning" plain size="mini" icon="el-icon-delete" circle title="删除"></el-button>
                <div style="border-bottom:dashed 1px grey;clear: both"></div>
              </div>
              <div class="reply-list">
                <sui-reply :childrenList="item.children" :item="item" @replyUser="replyUser" @del="del"></sui-reply>
              </div>
            </div>
          </div>
        </div>
