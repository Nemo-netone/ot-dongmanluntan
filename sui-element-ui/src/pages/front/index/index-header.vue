...
<template>
  <div class="main-header">
    ...
    <sui-user-collect ref="collect" type="收藏" path="categoryDetails"/>
    <div class="header">
      <div class="header-content">
        <div class="header-banner">
          <el-menu router :default-active="$route.path" style="width: 100%;height: 61px" class="el-menu-demo" mode="horizontal" background-color="#4288B0" text-color="#fff" active-text-color="#ffd04b">
            ...
            <el-menu-item index="/front/home">网站首页</el-menu-item>
            <el-menu-item index="/front/noticeList">动漫资讯</el-menu-item>
            <el-menu-item v-if="hasLogin" index="/front/articleList">我的文章</el-menu-item>
            <el-menu-item v-if="hasLogin" index="/front/integralList">积分排行</el-menu-item>
            <el-menu-item index="/front/discuss">社区交流</el-menu-item>
            <iframe class="tab pointer" scrolling="no" height="65" style="padding-top: 18px;position: absolute;right: 150px;width: 275px;" frameborder="0" src="https://i.tianqi.com/index.php?c=code&id=1&icon=1&num=3"></iframe>
            <div v-if="hasLogin">
              <el-dropdown class="pointer float-r">
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item icon="el-icon-star-off" @click.native="userCollect">我的收藏</el-dropdown-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      userLogin() {
        this.$refs.userLogin.open({title:'账号登录'});
      },
      userRegister() {
        this.$refs.userRegister.open({title:'用户注册'});
      },
      updateUserInfo() {
        this.$refs.userInfo.open({title:'用户信息'});
      },
      updatePassword() {
        this.$refs.password.open({title:'修改密码'});
      },
      userCollect() {
        this.$refs.collect.open({title:'我的收藏'});
      },
    }
  }
</script>
