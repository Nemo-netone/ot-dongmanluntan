package com.admin.sys.base.module.attach.web;
...
import com.admin.sys.base.module.attach.entity.SysAttach;
import com.admin.sys.base.module.attach.service.SysAttachService;
...
public class SysAttachController extends BaseController {
    ...
    */
    ...
    public void downFile(SysAttach params, HttpServletResponse response) throws Exception {
        SysAttach sysAttach = sysAttachService.get(params);
        if (sysAttach != null) {
